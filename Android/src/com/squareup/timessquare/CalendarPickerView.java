...
public class CalendarPickerView extends ListView {
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    setDivider(null);
    setDividerHeight(0);    
    final int bg = getResources().getColor(RHelper.getColor("calendar_bg"));
    setBackgroundColor(bg);
    setCacheColorHint(bg);    
    monthNameFormat = new SimpleDateFormat(context.getString(RHelper.getString("month_name_format")));
    weekdayNameFormat = new SimpleDateFormat(context.getString(RHelper.getString("day_name_format")));
  ...
  public class FluentInitializer {
    ...
    public FluentInitializer withLocale(Locale locale) {
      monthNameFormat =    		  
          new SimpleDateFormat(getContext().getString(RHelper.getString("month_name_format")), locale);
      for (MonthDescriptor month : months) {
        month.setLabel(monthNameFormat.format(month.getDate()));
      }
      weekdayNameFormat =
          new SimpleDateFormat(getContext().getString(RHelper.getString("day_name_format")), locale);
  ...
  private class DefaultOnInvalidDateSelectedListener implements OnInvalidDateSelectedListener {
    @Override public void onInvalidDateSelected(Date date) {    	
      String errMessage =
          getResources().getString(RHelper.getString("invalid_date"), fullDateFormat.format(minCal.getTime()),
